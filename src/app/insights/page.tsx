    ...
    <>
      ...
      <PageFrame aria-label="Insights introduction">
        ...
        <div className="px-5 pt-10 pb-10 md:px-10 md:pt-16 md:pb-14">
          <h1 className="font-display max-w-[24ch] text-[clamp(38px,4.2vw,76px)] leading-[1.05] font-medium tracking-[-0.01em]">
      ...
      {featured && (
        <PageFrame aria-label="Featured article">
          ...
          >
            <div>
              <h2 className="font-display max-w-[32ch] text-[clamp(30px,3vw,56px)] leading-[1.1] font-medium transition-colors group-hover:text-cobalt motion-reduce:transition-none">
