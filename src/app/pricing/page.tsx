...
const ROW_GRID = 'lg:grid-cols-[64px_1fr_200px_240px_220px] lg:items-center lg:gap-0';
  ...
  return (
    <>
      ...
      <PageFrame aria-label="The tiers">
        ...
        {PRICING_TIERS.map((tier) => (
          ...
          >
            ...
            <div className="lg:text-right">
              <span className="tnum block text-[26px] font-semibold">{tier.price}</span>
              {tier.priceDetail && (
        ...
        >
          <span aria-hidden="true" className="inline-block size-[9px] bg-cobalt" />
          <div className="lg:pr-8">
        ...
        <div className="grid lg:grid-cols-2">
          <div className="flex flex-col border-b border-hairline px-5 py-10 md:px-10 md:py-14 lg:border-r lg:border-b-0">
            ...
            <p className="tnum mt-6 max-w-[46ch] text-[16px] leading-relaxed text-ink/80">
              The Diagnostic is a fixed fee, agreed up front. It ends with a decision you can price,
        ...
        <div className="grid lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-5 py-10 md:px-10 md:py-14">
            ...
            <p className="mt-4 max-w-[52ch] text-[15px] leading-relaxed text-ink/80">
              A named operator. A weekly working cadence. A live adoption scoreboard. The system is
              not done when it ships. It is done when your team uses it.
            </p>
            <ul className="mt-6 border-t border-hairline text-[14px]">
              {ADOPTION_MILE_POINTS.map((point) => (
                <li key={point} className="flex items-center gap-3 border-b border-hairline py-3">
        ...
        <div className="grid lg:grid-cols-[1fr_2fr]">
          <div className="border-b border-hairline px-5 py-8 md:px-10 md:py-12 lg:border-r lg:border-b-0">
            ...
            <p className="tnum mt-4 max-w-[34ch] text-[14px] leading-relaxed text-ink/70">
              If yours is not here, the 30 minutes with the founder will cover it.
            </p>
          </div>
