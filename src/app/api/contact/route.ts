    ...
    const emailHtml = `
      <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto; color: #2D2D2D;">
        <div style="background: #0F1A2E; padding: 24px 32px; border-radius: 8px 8px 0 0;">
          <h1 style="color: #1F4CDB; font-size: 20px; margin: 0;">New ClearForge Inquiry</h1>
        ...
        <div style="padding: 32px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
          ...
          <div style="background: #F9FAFB; padding: 20px; border-radius: 8px; border-left: 3px solid #1F4CDB;">
