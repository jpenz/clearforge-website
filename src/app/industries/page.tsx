  ...
  return (
    <>
      <PageFrame aria-label="Industries introduction">
        <SectionBand left="Industries" right={`${INDUSTRIES.length} workflow patterns`} />
        <div className="px-5 py-10 md:px-10 md:py-14">
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-ink/70">
            Each page maps one industry's revenue workflow, the manual steps that slow it, the
            system we would build first, and clearly labeled benchmark ranges for the pattern. Pick
            yours.
          </p>
        </div>
      </PageFrame>
      ...
      <PageFrame bottomRule={false} aria-label="Next step">
        ...
        <div className="flex flex-col gap-5 px-5 py-10 md:flex-row md:items-center md:justify-between md:px-10">
          <p className="max-w-xl text-[15px] leading-relaxed text-ink/70">
            Not sure which pattern is yours? The fixed-fee Diagnostic maps your workflow in two
            weeks and prices the build before you commit.
          </p>
