      ...
      <section className="dark-section noise-texture relative overflow-hidden py-32 lg:py-48">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-end">
            <div className="lg:col-span-7">
              ...
              <FadeIn delay={0.15}>
                <p className="mt-6 max-w-xl text-body-lg text-stone">
                  Most manufacturers are generating more data than ever — from
                  IoT sensors and SCADA systems to ERP transactions and quality
                  logs. The problem is not data. The problem is that none of it
                  is working together to drive decisions.
                </p>
                <p className="mt-4 max-w-xl text-body text-stone">
                  ClearForge deploys AI that connects supply chain, maintenance,
                  quality, and workforce systems into a single intelligence
                  layer — built for production, not for pilots that never ship.
                </p>
                <div className="mt-10">
            ...
            {/* Right: headline result — magazine-style pull-quote */}
