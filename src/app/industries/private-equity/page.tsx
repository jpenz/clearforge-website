      ...
      <section className="dark-section noise-texture relative overflow-hidden py-32 lg:py-48">
        <div className="absolute inset-0 pointer-events-none">
          <video
            ...
            playsInline
            preload="metadata"
            poster="/images/abstract-value-creation.webp"
            className="absolute inset-0 w-full h-full object-cover opacity-55"
          >
            <source src="/videos/pe-value-creation.mp4" type="video/mp4" />
          </video>
            ...
            <div className="lg:col-span-7">
              ...
              <FadeIn delay={0.15}>
                <p className="mt-6 max-w-xl text-body-lg text-stone">
                  Private equity firms are sitting on an enormous, untapped
                  value creation lever. AI can accelerate EBITDA improvement
                  across portfolio companies — but only if it is deployed with
                  the speed, rigor, and measurability that PE operating models
                  demand.
                </p>
                <p className="mt-4 max-w-xl text-body text-stone">
                  ClearForge diagnoses AI opportunities, deploys production
                  systems in 90-day sprint cycles, and builds the operational
                  AI capabilities that command premium exit multiples.
                </p>
                <div className="mt-10">
              ...
              <FadeIn delay={0.25}>
                <div className="border-l border-brass/40 pl-8 lg:pl-10">
                  ...
                  <p className="mt-3 text-body-sm text-stone max-w-xs">
                    Delivered across three portfolio companies during a single
                    90-day sprint cycle.
                  </p>
                </div>
              </FadeIn>
