...
const SECTIONS: Array<{ heading: string; paragraphs: string[]; list?: string[] }> = [
  ...
  },
  {
    ...
    paragraphs: [
      'When you enter a company website address into Map the Workflow (on our homepage or at /discover), we fetch publicly available pages from that address and process the extracted text with AI model providers to generate your analysis.',
    ...
    <>
      <PageFrame aria-label="Privacy policy">
        ...
        <div className="px-5 py-10 md:px-10 md:py-14">
          <h1 className="font-display text-[clamp(28px,4vw,44px)] leading-tight">Privacy Policy</h1>
