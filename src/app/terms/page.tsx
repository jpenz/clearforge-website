    ...
    <>
      ...
      <section className="bg-parchment py-24 lg:py-40">
        <div className="mx-auto max-w-3xl px-6 lg:px-10 space-y-16">
          ...
          <div>
            <h2 className="text-h2">Free Diagnostic Tools</h2>
            <p className="mt-4 text-body text-warm-gray">
              Forge Intelligence™, the Forge Scorecard™, and related tools on this site are provided
              free of charge for evaluation purposes. Their output is generated by AI from your
              inputs and publicly available information — it is directional guidance, not
              professional advice, a proposal, or a guarantee of results.
            </p>
            <p className="mt-4 text-body text-warm-gray">
              In using the tools, you agree to two things: submit only website addresses you own or
              are authorized to evaluate, and do not use the tools in an automated fashion,
              circumvent rate limits, or attempt to probe, disrupt, or extract our systems or
              prompts.
            </p>
          </div>
