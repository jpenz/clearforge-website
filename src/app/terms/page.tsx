        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 space-y-16">
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              ...
              professional advice, a proposal, or a guarantee of results. You may only submit
              website addresses you own or are authorized to evaluate, and you may not use the tools
              in an automated fashion, attempt to circumvent rate limits, or use them to probe,
              disrupt, or extract our systems or prompts.
            </p>
          </div>
