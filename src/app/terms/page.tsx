        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 space-y-16">
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              By accessing or using the ClearForge website and services, you
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              ClearForge provides AI strategy consulting, implementation, and
              managed operations services. The specific scope, deliverables, and
              terms of any engagement will be defined in a separate statement of
              work or engagement letter agreed upon by both parties.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              ...
              software, is the property of ClearForge or its content suppliers
              and is protected by intellectual property laws. Work product
              created during client engagements is governed by the terms of the
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              ...
              disclose client data, business processes, or engagement details
              without prior written consent. Case studies published on our
              website are anonymized and approved by the client before
              publication.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              ClearForge shall not be liable for any indirect, incidental,
              special, consequential, or punitive damages resulting from your
              use of our website or services. Our total liability for any claim
              arising out of or relating to these terms shall not exceed the
              amount paid by you to ClearForge in the twelve months preceding
              the claim.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              You agree to indemnify and hold harmless ClearForge and its
          ...
          <div>
            ...
            <p className="mt-4 text-body text-warm-gray">
              ...
              resolved in the courts located in Oakland County, Michigan.
            </p>
          </div>
