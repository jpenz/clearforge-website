...
export function calculateScore(answers: Answers): ScoreResult {
  ...
  if (percentage >= 75) {
    ...
    tier = 'ready';
    tierDescription =
      "You're AI Ready. You have solid foundations and are positioned for targeted AI implementation. Focus on your strongest areas to generate quick wins and build momentum across the organization.";
