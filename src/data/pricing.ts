...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    subtitle: 'For AI systems you already built. An eval harness, reliability gates, a fix plan.',
    term: 'Fixed fee · 2 weeks',
    price: 'Fixed fee',
    minPrice: 15000,
    maxPrice: 15000,
  ...
  },
  {
    index: '04',
    name: 'Forge Scale',
    subtitle: 'The Adoption Mile. The top tier is a Fractional Chief AI Officer engagement.',
    term: 'Monthly',
...
export const FIRST_TWO_WEEKS = [
  {
    ...
    description: 'We sit inside the workflow and put a number on what the manual steps cost.',
  },
  {
    label: 'Week 2',
    title: 'Prove viability, price the build',
    description: 'We test the system against your real data and scope the Sprint.',
  },
  {
    label: 'Day 10 to 14',
    title: 'A decision you can price',
    description: 'Build, fix, or stop. If you build, the Sprint arrives already priced.',
  },
];
