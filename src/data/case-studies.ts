...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    outcomes: [
      { metric: "1,181", description: "Qualified opportunities identified across 3 divisions in 6 months" },
      { metric: "99.8%", description: "Match rate to the client's actual product capabilities" },
      { metric: "32x", description: "Ramp from 19 to 613 opportunities per month during calibration" },
