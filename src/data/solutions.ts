    ...
    howItWorks: [
      {
        phase: 'Week 1',
        detail:
          'Leadership and operator interviews, baseline KPI mapping, and process signal review.',
      },
      {
        phase: 'Week 2',
        detail: 'Opportunity sizing and feasibility scoring across growth, efficiency, and risk.',
      },
      {
        phase: 'Week 3',
        detail: 'Target operating model design, governance structure, and initiative sequencing.',
      },
      {
        phase: 'Week 4',
        detail: 'Executive readout with implementation blueprint and first-quarter workplan.',
      },
    ],
    scope: {
      timeline: '2-4 weeks',
    ...
    faqs: [
      {
        ...
        answer:
          'No. This engagement is designed for teams at the beginning or reset stage. We identify where internal capability is enough and where external support is needed.',
      },
      {
        question: 'Will we leave with actionable next steps, not just strategy slides?',
        answer:
          'Yes. The output is a sequenced implementation plan with named owners, measurable goals, and operating cadence.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          'We set confidence thresholds, escalation paths, and human approvals on high-impact actions before launch.',
      },
      {
        question: 'Can we start small and expand later?',
        answer:
          'Yes. We typically launch in one workflow first, prove value, and then extend the architecture to adjacent workflows.',
      },
    ],
  },
  {
    ...
    howItWorks: [
      {
        phase: 'Month 1',
        detail: 'Baseline and service setup, KPI targets, and governance cadence.',
      },
    ...
    faqs: [
      {
        ...
        answer:
          'No. We extend your team and transfer capability over time while maintaining execution momentum.',
      },
      {
        question: 'How quickly should we expect measurable impact?',
        answer:
          'Most clients see measurable movement within the first 30-90 days, depending on data and workflow complexity.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          'No. Most clients realize value faster by modernizing targeted workflows and building bridges around the existing core.',
      },
      {
        question: 'How do you control risk during modernization?',
        answer:
          'We sequence by business criticality, use staged rollouts, and maintain rollback options for each transition phase.',
      },
    ],
  },
  {
    ...
    headline:
      'Unify demand generation, qualification, and pipeline operations with AI-enabled execution.',
    summary:
    ...
    faqs: [
      {
        ...
        answer:
          'No. We run this model for lean teams and larger organizations by matching automation depth to team capacity.',
      },
      {
        question: 'Can this align with our existing sales process?',
        answer:
          'Yes. We map to your current process first, then improve constraints without forcing disruptive wholesale change.',
      },
    ],
  },
];
