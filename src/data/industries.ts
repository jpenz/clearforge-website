    ...
    workflowSteps: [
      {
        ...
        description: 'A buyer emails a drawing or spec pack. Someone re-types it into the system.',
      },
      {
      ...
      {
        title: 'Order booked',
        description: 'The win is keyed into the ERP by hand. Nothing from the quote carries over.',
      },
    ],
    system: {
    ...
    workflowSteps: [
      {
        ...
        description: 'Requests come in by phone and web form. Someone triages each one by hand.',
      },
      {
    ...
    workflowSteps: [
      {
        ...
        description: 'Orders arrive by email and portal. Someone re-keys each line into the ERP.',
      },
      {
        title: 'Availability check',
        description: 'Stock and lead times are checked by hand across systems and suppliers.',
      },
      {
  ...
  },
  {
    ...
    workflowSteps: [
      ...
      },
      {
        ...
        description: 'Costs are built from history and supplier calls. Risk is priced by feel.',
      },
      {
