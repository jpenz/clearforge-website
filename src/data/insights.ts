export type Inline = string | { text: string; bold?: boolean; tnum?: boolean; href?: string };
...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    standfirst: 'Why we hold every system to 70 percent weekly-active use by day 90.',
    summary:
  ...
  },
  {
    ...
    summary: 'What eval harnesses and reliability gates are, and why they are a named deliverable.',
    blocks: [
      {
        type: 'lead',
        content: [
  ...
  },
  {
    ...
    standfirst: 'What happens between kickoff and a live production system.',
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        content: ['Leaders can assess maturity by scoring six signals for each AI initiative:'],
      },
      {
        type: 'list',
        items: [
      ...
      {
        type: 'paragraph',
        content: ['That is the difference between AI activity and AI transformation.'],
      },
  ...
  },
  {
    ...
    standfirst: 'Treat AI as a portfolio operating capability, not a collection of experiments.',
    summary:
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        content: ['The most effective PE teams run a recurring AI value creation cadence:'],
      },
      {
        type: 'list',
        items: [
      ...
      {
        type: 'paragraph',
        content: ['That cadence turns learning into an operating asset.'],
      },
      {
        type: 'pullquote',
        text: 'Choose plays,',
  ...
  },
  {
    ...
    standfirst: 'AI leaders are compounding advantages while most companies stay in pilot loops.',
    summary:
  ...
  },
  {
    ...
    standfirst: 'Where agents create value, where they fail, and what CEOs must do now.',
    summary:
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        content: ['These metrics keep leadership grounded in outcomes rather than feature lists.'],
      },
  ...
  },
  {
    ...
    standfirst: 'Most organizations cannot rip and replace core systems. They do not need to.',
    summary:
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        content: ['Bridge modernization still requires discipline. Four controls are essential:'],
      },
      {
        type: 'list',
        items: [
  ...
  },
  {
    ...
    standfirst: 'Most pilots optimize for technical novelty instead of operating outcomes.',
    summary:
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        content: ['Before approving any pilot, leadership should be able to answer:'],
      },
      {
        type: 'list',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        content: ['Organizations that avoid this design question often drift into confusion:'],
      },
      {
        type: 'list',
        items: [
      ...
      {
        type: 'paragraph',
        content: ['Training should map to real workflows, not generic AI literacy modules.'],
      },
      ...
      {
        type: 'paragraph',
        content: ['Ignoring these elements creates resistance that no model quality can solve.'],
      },
  ...
  },
  {
    ...
    standfirst: 'What they are, what they are not, and when you need one.',
    summary:
    ...
    blocks: [
      ...
      { type: 'heading', text: 'Free vs paid assessments' },
      {
        ...
        rows: [
          ...
          ['Vendor-led audit', 'Free', '1 to 3 hours', 'Vendor-tilted recommendations'],
          [
            'Paid diagnostic',
            '$10K to $25K',
            '2 to 6 weeks',
