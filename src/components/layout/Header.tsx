 ...
 * text, the cobalt button, and a ghost hairline below. Five links plus
 * one button, complete at every width: at mobile the header becomes two
 * tiers (brand + Book button, then the five links in a wrapping row) and
 * scrolls with the page, since pinning 155px of a phone viewport would
 * cost the reader a fifth of every screen. Nothing hides behind a
 * hamburger.
 */
