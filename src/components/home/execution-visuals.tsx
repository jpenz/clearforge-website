  ...
  useGSAP(
    () => {
      ...
      tl.to(dimDots, { opacity: 1, duration: 0.5, stagger: 0.02 })
        ...
        .to(
          hotspotRing,
          { scale: 1.3, opacity: 0.3, duration: 1.2, repeat: -1, yoyo: true, ease: 'sine.inOut' },
          2.1,
        );
    },
    { scope: svgRef },
...
export function SystemVisual() {
  ...
  useGSAP(
    () => {
      ...
      tl.to(grid, { opacity: 1, duration: 0.4 })
        ...
        .to(
          connections,
          { strokeDashoffset: 0, duration: 0.8, stagger: 0.05, ease: 'power2.inOut' },
          0.5,
        )
        ...
        .to(
          lens,
          { scale: 1.04, opacity: 0.85, duration: 1.5, repeat: -1, yoyo: true, ease: 'sine.inOut' },
          2,
        );
    },
    { scope: svgRef },
  ...
  return (
    <svg ref={svgRef} viewBox="0 0 420 380" className="w-full h-auto" aria-hidden>
      ...
      <path
        className="s-conn"
        d="M 46,100 Q 100,120 140,155 L 165,172"
        fill="none"
        stroke="rgba(5,158,135,0.45)"
        strokeWidth="1.5"
        strokeDasharray="200"
      ...
      <path
        className="s-conn"
        d="M 46,155 Q 90,160 130,168 L 165,178"
        fill="none"
        stroke="rgba(5,158,135,0.45)"
        strokeWidth="1.5"
        strokeDasharray="200"
      ...
      <path
        className="s-conn"
        d="M 46,210 Q 90,205 130,198 L 165,190"
        fill="none"
        stroke="rgba(5,158,135,0.45)"
        strokeWidth="1.5"
        strokeDasharray="200"
      ...
      <path
        className="s-conn"
        d="M 46,265 Q 100,245 140,215 L 165,198"
        fill="none"
        stroke="rgba(5,158,135,0.45)"
        strokeWidth="1.5"
        strokeDasharray="200"
      ...
      <path
        className="s-conn"
        d="M 267,162 Q 295,145 320,130 L 345,118"
        fill="none"
        stroke="rgba(5,158,135,0.55)"
        strokeWidth="1.5"
        strokeDasharray="200"
      ...
      <path
        className="s-conn"
        d="M 267,183 Q 295,183 320,183 L 345,183"
        fill="none"
        stroke="rgba(5,158,135,0.6)"
        strokeWidth="1.5"
        strokeDasharray="200"
      />
      <path
        className="s-conn"
        d="M 267,204 Q 295,220 320,234 L 345,248"
        fill="none"
        stroke="rgba(5,158,135,0.55)"
        strokeWidth="1.5"
        strokeDasharray="200"
      ...
      <circle className="s-flow" r="2.5" fill="#059E87">
        <animateMotion
          ...
          path="M 46,155 Q 90,160 130,168 L 165,178 L 215,183"
        />
      </circle>
      <circle className="s-flow" r="2.5" fill="#059E87" opacity="0.8">
        <animateMotion
          dur="2.5s"
          repeatCount="indefinite"
          path="M 267,183 Q 295,183 320,183 L 355,183"
          begin="0.5s"
        />
      </circle>
      <circle className="s-flow" r="2" fill="#059E87" opacity="0.7">
        <animateMotion
          dur="3.5s"
          repeatCount="indefinite"
          path="M 46,210 Q 90,205 130,198 L 165,190 L 215,183"
          begin="1s"
        />
      </circle>
...
export function DashboardVisual() {
  ...
  const barData = [
    0.2, 0.28, 0.35, 0.32, 0.42, 0.48, 0.45, 0.55, 0.58, 0.62, 0.68, 0.72, 0.78, 0.85, 0.92,
  ];
  const trendPoints =
    '75,230 95,218 115,222 135,208 155,200 175,192 195,182 215,170 235,158 255,148 275,135 295,120 315,105 335,90 355,75';
    ...
    <svg ref={svgRef} viewBox="0 0 420 380" className="w-full h-auto" aria-hidden>
      ...
      <circle className="o-flow" r="2" fill="#059E87">
        <animateMotion
          dur="4s"
          repeatCount="indefinite"
          path="M 95,40 Q 150,42 200,75 Q 260,110 320,100"
        />
      </circle>
      <circle className="o-flow" r="2" fill="#059E87" opacity="0.7">
        <animateMotion
          dur="3.5s"
          repeatCount="indefinite"
          path="M 95,40 Q 140,65 180,95 Q 230,130 280,140"
          begin="0.8s"
        />
      </circle>
      ...
      <g className="o-metric">
        ...
        <text x="70" y="310" fill="#059E87" fontSize="18" fontFamily="monospace" fontWeight="bold">
          +42%
        </text>
      </g>
      <g className="o-metric">
        ...
        <text x="185" y="310" fill="#059E87" fontSize="18" fontFamily="monospace" fontWeight="bold">
          -31%
        </text>
      </g>
      <g className="o-metric">
        ...
        <text x="300" y="310" fill="#059E87" fontSize="18" fontFamily="monospace" fontWeight="bold">
          94%
        </text>
      </g>
