 ...
 * viewport, over the adoption-field back plate. It is capped below the
 * measured result numerals (1,181 on the proof band above it, 72px to 128px):
 * a target must not be the biggest number on the site. No label rail opens the
    ...
    <section aria-label="The adoption target" className="cf-dark-band overflow-clip text-ghost">
      ...
      <Container gutter="cells" className="relative">
        <div className="grid items-center gap-8 px-5 py-16 md:px-10 md:py-24 lg:min-h-[600px] lg:grid-cols-[auto_1fr] lg:gap-16">
          <p className="font-display tnum text-[clamp(64px,6vw,112px)] leading-[0.85] font-medium">
            <CountUp value={70} />
