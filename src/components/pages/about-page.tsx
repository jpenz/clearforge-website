...
const values = [
  ...
  },
  {
    ...
    description: 'We keep recommendations clear, practical, and grounded in measurable outcomes.',
  },
];
...
const approach = [
  ...
  },
  {
    ...
    description: 'We run and optimize systems so value compounds instead of decaying after launch.',
  },
];
  ...
  return (
    <>
      ...
      <section className="relative bg-bg-deep pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        <Image
          src="/images/about-forge-concept.png"
          alt=""
          fill
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-relaxed text-text-secondary">
              ClearForge was built for leaders who need more than recommendations. We combine
              management consulting rigor with hands-on delivery so strategy turns into live systems
          ...
          <div className="mt-12 grid gap-px bg-border-light md:grid-cols-3">
            {clients.map((c) => (
              <div key={c.title} className="bg-bg-light p-8">
                <h3 className="text-lg font-semibold text-text-on-light">{c.title}</h3>
                <p className="mt-2 text-base text-text-on-light-sub">{c.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative bg-bg-deep py-20 lg:py-28 hero-glow overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <p className="mt-4 text-lg text-text-secondary">
            A real conversation about where AI fits in your operation and what it would take to get
            there.
          </p>
          <div className="mt-8">
