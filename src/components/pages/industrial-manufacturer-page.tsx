      ...
      <section className="relative bg-bg-deep pt-32 pb-12 lg:pt-40 lg:pb-16 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 lg:px-8 z-10">
          <motion.div {...fadeUp}>
            ...
            >
              A multi-billion dollar enterprise deployed AI across its commercial organization — and
              built the growth engine it never had.
            </h1>
            <p className="mt-8 text-lg text-text-secondary max-w-2xl leading-relaxed lg:text-xl">
              Multiple divisions. Decades of market leadership. No shared intelligence, no unified
              pipeline, and no system to find revenue growth hiding across the portfolio. ClearForge
              changed that in six months.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {[
              ...
              >
                <div className="flex items-baseline gap-4 mb-4">
                  ...
                  <span className="text-base lg:text-lg text-text-secondary">{item.label}</span>
                </div>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <motion.div {...fadeUp}>
            ...
            <div className="mt-10 space-y-6 text-base text-text-on-light-sub leading-[1.8]">
              <p>
                The organization had operated for decades on relationships and reputation. Each
                group ran its own sales motion — different tools, different processes, different
                definitions of a qualified lead. There was no shared view of where capital was
                flowing, which accounts were under-served, or where the real white space existed
              ...
              <p>
                Leadership knew the growth was there. They needed a system to surface it, a platform
                to act on it, and an operating model that could scale without adding headcount.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="space-y-24">
            <motion.div {...fadeUp}>
              ...
              <p className="text-base text-text-secondary leading-[1.8] max-w-2xl">
                Calibrated to the client&apos;s exact capabilities, the agents monitor capital
                projects, demand signals, and competitive movements across 20+ states. Every
                opportunity is scored, enriched, and matched in real time. The model gets sharper
                with every signal it processes.
              </p>
            </motion.div>
            ...
            <motion.div {...fadeUp}>
              ...
              <p className="text-base text-text-secondary leading-[1.8] max-w-2xl">
                Pipeline management, AI-generated playbooks, automated contact discovery,
                performance analytics — deployed on a dedicated instance for the client&apos;s sales
                organization. Not a dashboard they log into once. A system they run their business
                from. Structured feedback loops ensure every interaction makes the AI smarter.
              </p>
            </motion.div>
            ...
            <motion.div {...fadeUp}>
              ...
              <p className="text-base text-text-secondary leading-[1.8] max-w-2xl">
                Diagnostic-first. Revenue assessment, account segmentation by margin contribution,
                role architecture aligned to where the growth is. The AI tells you where to aim. The
                commercial model ensures the organization is structured to get there. No guessing.
                No adding bodies. Just precision.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <motion.div {...fadeUp}>
            ...
            <div className="space-y-6 text-base text-text-on-light-sub leading-[1.8]">
              <p>
                AI agents monitor thousands of market signals daily. Every closed-won and
                closed-lost data point refines the scoring model. Precision compounds month over
                month.
              </p>
              <p>
                New territories and groups are added continuously. The intelligence architecture
                scales horizontally — each deployment accelerates faster than the last because the
                base model has already learned the market.
              </p>
              <p>
                Structured feedback on every playbook creates a closed-loop system. Sales reps rate
                quality across four dimensions. The AI improves automatically. Market shifts are
                captured within hours, not weeks — ensuring the team always has first-mover
                advantage.
              </p>
              <p className="text-text-on-light font-medium">
                By month twelve, the precision and coverage will be fundamentally different from
                month one. That&apos;s the design.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <motion.div {...fadeUp}>
            <blockquote>
              <p
                ...
                style={{ fontFamily: 'var(--font-heading)' }}
              >
                &ldquo;What started as a pilot across a few groups became an enterprise-wide
                intelligence system in under six months — with a custom platform the sales team uses
                daily, a pipeline that didn&apos;t exist before, and a roadmap to transform the
                commercial model entirely.&rdquo;
              </p>
            </blockquote>
            <p className="mt-10 text-base text-text-secondary leading-relaxed max-w-3xl">
              The architecture now covers multiple groups with over a thousand active opportunities
              — and additional divisions ready for deployment. The system gets exponentially smarter
              every month. ClearForge is now designing a commercial model transformation to align
              the client&apos;s sales structure, compensation, and coverage model to the
              intelligence the AI is generating.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          <motion.div {...fadeUp}>
            ...
            <p className="mt-6 text-lg text-text-secondary max-w-2xl mx-auto leading-relaxed">
              ...
              pipeline, enable sales teams, and compound over time. One conversation to find out
