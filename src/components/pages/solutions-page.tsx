  ...
  return (
    <>
      ...
      <section className="bg-gray-50 py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-8 rounded-2xl border border-gray-200 bg-white p-7 text-center text-xl font-semibold text-slate-navy sm:text-2xl">
                ...
                <div key={stage} className="rounded-2xl border border-gray-200 bg-white p-7">
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    {items.map((solution) => {
                      ...
                      return (
                        <article key={solution.slug} className="rounded-xl border border-gray-200 border-l-4 border-l-teal bg-gray-50 p-6">
