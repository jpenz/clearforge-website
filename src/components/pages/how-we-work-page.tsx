      ...
      <section className="relative overflow-hidden bg-navy py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <h1 className="mt-4 text-4xl font-bold text-white sm:text-5xl">
            Engagement models built for execution, not slideware.
          </h1>
          <p className="mt-6 max-w-3xl text-lg text-white/80">
            ClearForge engagements are scoped around your operating priorities, timeline, and
            internal capacity. We focus on measurable business outcomes and practical adoption.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {firstWeekPlan.map((item) => (
              <div
                key={item}
                className="rounded-xl border border-border bg-white p-6 text-base text-text-secondary"
              >
                {item}
              </div>
            ))}
      ...
      <section className="bg-navy py-20 lg:py-28">
        <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
          <h2 className="text-3xl font-bold text-white">
            Start with the right engagement model for your goals.
          </h2>
          <p className="mt-4 text-lg text-white/80">
            Most clients begin with an AI Strategy Sprint and expand based on results.
          </p>
