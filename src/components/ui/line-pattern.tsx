...
export function LinePattern({ className }: LinePatternProps) {
  ...
  return (
    <svg className={className} viewBox="0 0 800 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path d="M0 100 Q200 30 400 100 Q600 170 800 100" stroke={`url(#${gradientId})`} strokeWidth="1.5" strokeLinecap="round" opacity="0.3" />
      <path d="M0 120 Q200 50 400 120 Q600 190 800 120" stroke={`url(#${gradientId})`} strokeWidth="1" strokeLinecap="round" opacity="0.2" />
