    ...
    <div className="py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="mt-6 text-4xl font-bold text-text-primary sm:text-5xl">{service.title}</h1>
          <p className="mt-4 text-lg text-text-secondary">{service.tagline}</p>
          <p className="mt-6 text-text-secondary leading-relaxed">{service.description}</p>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <p className="text-sm font-medium uppercase tracking-wider text-blue">Ideal Client</p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-center text-3xl font-bold text-text-primary">What We Deliver</h2>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-center text-3xl font-bold text-text-primary">Typical Outcomes</h2>
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {service.outcomes.map((outcome, i) => (
              ...
              >
                <p className="text-2xl font-bold text-text-primary">{outcome.metric}</p>
                <p className="mt-2 text-sm text-text-muted">{outcome.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {service.workflow.map((step, i) => (
              ...
              >
                <span className="text-xs font-medium text-blue">{step.phase}</span>
        ...
        >
          ...
          <p className="mt-4 text-text-secondary">
            Book a free discovery call to discuss how {service.title.toLowerCase()} can drive
